            ...
            <div class="navbar-size">
                <div class="container">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="inside-dashboard-content">
                            <a href="writer.php" class="dashboard-content-name">Writers</a>
                        </div>
                        <div class="inside-dashboard-content">
                    ...
                    <ul class="navbar-nav mr-auto sidenav" id="navAccordion">
                        ...
                        <div class="leftsidebar-second-section">
                            ...
                            <div class="navbar-left-side-content">
                                ...
                                <div class="contents-here overviewpage"><a href="writer.php" class="content-link">Writers</a></div>
                ...
                <div class="mt-4">
                    <div class="container">
                        ...
                        <div class="row mr-2">
                            ...
                            <!-- <div>
                                <div id="piechart" style="width: 400px; height: 300px; margin:0; padding:0;"></div>
                            </div>
                            <div class="container mt-3">
                                <hr>
                                <span class="overview-update">UPDATE STATUS</span>
                            </div>
                            <div class="container">
                                <div class="row mt-3">
                                    <div class="col-xxl-3 col-xl-1 xol-lg-3 col-md-2 col-sm-3 col-6 text-center">
                                        <a href="" class="overview-button-content">&nbsp;Assign&nbsp;&nbsp;</a>
                                    </div>
                                    <div class="col-xxl-3 col-xl-1 xol-lg-3 col-md-2 col-sm-3 col-6 text-center">
                                        <a href="" class="overview-button-content">Payment</a>
                                    </div>
                                    <div
                                        class="col-xxl-3 col-xl-1 xol-lg-3 col-md-2 col-sm-3 col-6 button-text text-center">
                                        <a href="" class="overview-button-content">Delivered</a>
                                    </div>
                                    <div
                                        class="col-xxl-3 col-xl-1 xol-lg-3 col-md-2 col-sm-3 col-6 button-text text-center">
                                        <a href="" class="overview-button-content">Charges</a>
                                    </div>

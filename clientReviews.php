  ...
  <div class="website-start">
      ...
      <div class="navbar-size">
        <div class="mobile-user-details">
          ...
          <div class="text-center mt-3">
            <p class="text-center mb-4"><a href="" class="mobile-linked-page">Overview</a></p>
            <p class="text-center mb-4"><a href="" class="mobile-linked-page">Assignments</a></p>
            <p class="text-center mb-4"><a href="" class="mobile-linked-page">Exports</a></p>
          ...
          <div class="text-center mt-3">
            ...
            <p class="text-center mb-4"><a href="" class="mobile-linked-page">LOG OUT</a></p>
          </div>
        </div>
      </div>
          ...
          <ul class="navbar-nav mr-auto sidenav" id="navAccordion">
            ...
            <div class="leftsidebar-second-section">
              ...
              <div class="navbar-left-side-content">
                <div class="contents-here overviewpage"><a href="" class="content-link ">Overview</a></div>
            ...
            <div class="leftsidebar-second-section">
              ...
              <div class="navbar-left-side-content">
                ...
                <div class="contents-here"><a href="" class="content-link">LOG OUT</a></div>
              </div>
            </div>
    ...
    <div class="">
      <main class="content-wrapper">
        <!-- right side -->
        <div class="headerr">
          <a href="overview.php"><img src="leftarrow.png" width="20px"/></a>
          <p>Client Reviews</p>
        </div>
        ...
        <div class="assignment">
          <div class="assignmentBox">
              ...
              <p id="assignmentLine3">Reviews</p>
              <p id="assignmentLine4">Writer Assigned</p>
          </div>
          <div class="assignmentDetailsBox">
              <div class="ss">
                  ...
                  <div id="assignmentDetailsLine3">The work was on time and was perfectly done.</div>
                  <div id="assignmentDetailsLine4">Nate Diaz<br/></div>
